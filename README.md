...
- `ACLED_EMAIL`, `ACLED_PASSWORD`: ACLED conflict/unrest inputs. (Many accounts get `403` “permission is required”; in that case set `DISABLE_ACLED=1` to silence ACLED and rely on GDELT/UCDP fallbacks.)
